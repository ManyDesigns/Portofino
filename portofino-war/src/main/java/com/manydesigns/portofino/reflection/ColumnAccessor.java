...
public class ColumnAccessor implements PropertyAccessor {
    ...
    protected final Autogenerated autogeneratedAnnotation;
    ...
    public ColumnAccessor(Column column, boolean inPk,
        ...
        requiredAnnotation = new RequiredImpl(!column.isNullable());
        immutableAnnotation = new ImmutableImpl(inPk);
        autogeneratedAnnotation =
                new AutogeneratedImpl(column.isAutoincrement());
        searchableAnnotation = new SearchableImpl(column.isSearchable());
    }
    ...
    public <T extends Annotation> T getAnnotation(Class<T> annotationClass) {
        ...
        } else if (annotationClass == Autogenerated.class) {
            return (T) autogeneratedAnnotation;
