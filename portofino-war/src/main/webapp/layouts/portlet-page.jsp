<%@ page contentType="text/html;charset=ISO-8859-1" language="java"
    ...
    <stripes:layout-component name="portletPageHeader">
        <div class="yui-g">
            ...
            <div class="portletPageBarRight">
                <!-- Admin buttons -->
                <div class="portletPageBarButtons">
