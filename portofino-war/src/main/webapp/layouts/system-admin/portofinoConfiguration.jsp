...
<div class="tabs-bar-top">
    ...
    <ul class="tabs">
        <li class="selected"><s:a href="%{#portofinoConfigurationUrl}"><fmt:message key="layouts.system-admin.portofino_properties"/></s:a></li>
...
<div id="inner-content">
    <h1><fmt:message key="layouts.system-admin.portofino_properties"/></h1>
