    ...
    public void testManageDataSource() throws Exception {
      System.out.println("testLinkHomePage:");
        ...
        assertTrue(text.contains("<table><thead><tr><th>&nbsp;" +
                "</th><th>Database name</th><th>Description</th><th>Status</th></tr></thead><tbody><tr><td><input type=\"checkbox\" name=\"selection\" value=\"jpetstore\"></input></td><td><div class=\"value\" id=\"row0_databaseName\"><a href=\"/model/ConnectionProviders.action?databaseName=jpetstore\">jpetstore</a></div></td><td><div class=\"value\" id=\"row0_description\">JDBC connection to URL: jdbc:h2:mem:jpetstore</div></td><td><div class=\"value status_green\" id=\"row0_status\">connected</div></td></tr><tr><td><input type=\"checkbox\" name=\"selection\" value=\"hibernatetest\"></input></td><td><div class=\"value\" id=\"row1_databaseName\"><a href=\"/model/ConnectionProviders.action?databaseName=hibernatetest\">hibernatetest</a></div></td><td><div class=\"value\" id=\"row1_description\">JDBC connection to URL: jdbc:h2:mem:hibernatetest</div></td><td><div class=\"value status_green\" id=\"row1_status\">connected</div></td></tr><tr><td><input type=\"checkbox\" name=\"selection\" value=\"portofino\"></input></td><td><div class=\"value\" id=\"row2_databaseName\"><a href=\"/model/ConnectionProviders.action?databaseName=portofino\">portofino</a></div></td><td><div class=\"value\" id=\"row2_description\">JDBC connection to URL: jdbc:h2:mem:portofino4</div></td><td><div class=\"value status_green\" id=\"row2_status\">connected</div></td></tr></tbody></table>"));
        ...
        assertEquals("Codice risposta.",
                HttpServletResponse.SC_OK, resp.getResponseCode());
        text = resp.getText();
        assertTrue(text.contains("<tr><td><input type=\"checkbox\" name=\"selection\" value=\"simon\"></input></td><td><div class=\"value\" id=\"row3_databaseName\"><a href=\"/model/ConnectionProviders.action?databaseName=simon\">simon</a></div></td><td><div class=\"value\" id=\"row3_description\">JDBC connection to URL: jdbc:postgresql://127.0.0.1:5432/simon</div></td><td><div class=\"value\" id=\"row3_status\"></div></td></tr>"));
        ...
        assertEquals("Codice risposta.",
                        HttpServletResponse.SC_OK, resp.getResponseCode());
        text = resp.getText();
        assertTrue(text.contains("<tr><td><input type=\"checkbox\" name=\"selection\" value=\"simon\"></input></td><td><div class=\"value\" id=\"row3_databaseName\"><a href=\"/model/ConnectionProviders.action?databaseName=simon\">simon</a></div></td><td><div class=\"value\" id=\"row3_description\">JDBC connection to URL: jdbc:postgresql://localhost:5432/simon</div></td><td><div class=\"value\" id=\"row3_status\"></div></td></tr>"));
        ...
        assertEquals("Codice risposta.",
                HttpServletResponse.SC_OK, resp.getResponseCode());
        text = resp.getText();
        assertFalse(text.contains("<tr><td><input type=\"checkbox\" name=\"selection\" value=\"simon\"></input></td><td><div class=\"value\" id=\"row3_databaseName\"><a href=\"/model/ConnectionProviders.action?databaseName=simon\">simon</a></div></td><td><div class=\"value\" id=\"row3_description\">JDBC connection to URL: jdbc:postgresql://127.0.0.1:5432/simon</div></td><td><div class=\"value\" id=\"row3_status\"></div></td></tr>"));
