...
import com.manydesigns.portofino.pageactions.gallery.GalleryAction;
...
public class GalleryModule implements Module {
    ...
    public static final Logger logger = LoggerFactory.getLogger(GalleryModule.class);
    ...
    @Override
    public void init() {
        pageActionRegistry.register(GalleryAction.class);
