...
public class GroovyScriptEngine implements ResourceConnector {
    ...
    public static final Logger logger = LoggerFactory.getLogger(GroovyScriptEngine.class);
    ...
    private class ScriptClassLoader extends GroovyClassLoader {
        ...
        private Class doParseClass(GroovyCodeSource codeSource) {
            logger.debug("doParseClass: {} - {}", codeSource.getName(), codeSource.getFile());
            ...
            for (Map.Entry<String, Set<String>> entry : cache.entrySet()) {
                ...
                logger.debug("PUT: {} lastModified: {} time: {}", new Object[] { entryName, lastModified, time });
    ...
    /**
     * This method closes a {@link java.net.URLConnection} by getting its {@link java.io.InputStream} and calling the
     * {@link java.io.InputStream#close()} method on it. The {@link java.net.URLConnection} doesn't have a close() method
     ...
     *
     * @param urlConnection the {@link java.net.URLConnection} to be "closed" to close the underlying file descriptors.
     */
     ...
     * {@link groovy.lang.GroovyClassLoader} in which scripts will be executed. By default, this is the
     ...
     * @throws groovy.util.ResourceException if there is a problem accessing the script
