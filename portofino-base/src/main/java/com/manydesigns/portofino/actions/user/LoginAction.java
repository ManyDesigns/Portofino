...
public abstract class LoginAction extends AbstractActionBean {
    ...
    protected String getLoginPage() {
        return "/m/portofino-base/actions/user/login.jsp";
    }
    ...
    public Resolution resetPassword() {
        ...
        return new ForwardResolution("/m/portofino-base/actions/user/resetPassword.jsp");
    }
    ...
    protected String getForgotPasswordPage() {
        return "/m/portofino-base/actions/user/forgotPassword.jsp";
    }
    ...
    protected String getSignUpPage() {
        return "/m/portofino-base/actions/user/signUp.jsp";
    }
    ...
    public Resolution changePassword() throws Exception {
        return new ForwardResolution("/m/portofino-base/actions/user/changePassword.jsp");
    }
