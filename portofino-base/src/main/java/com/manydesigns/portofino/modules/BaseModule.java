    ...
    protected void setupHead() {
        headBuilder.appenders.add(new HtmlHeadAppender() {
            ...
            public void append(HtmlHead head) {
                ...
                xb.writeLink("stylesheet", "text/css",
                             Util.getAbsoluteUrl("/m/portofino-base/jquery-ui/css/no-theme/jquery-ui-1.10.3.custom.min.css"));
                ...
                xb.closeElement("script");
                xb.openElement("script");
                xb.addAttribute("src", Util.getAbsoluteUrl("/m/portofino-base/jquery-ui/js/jquery-ui-1.10.3.custom.min.js"));
                xb.closeElement("script");
