...
public class ApplicationWizard extends AbstractWizardPageAction {
    ...
    protected Resolution createConnectionProviderForm() {
        step = 0;
        return new ForwardResolution("/META-INF/resources/m/wizard/connection-provider.jsp");
    }
    ...
    protected Resolution selectSchemasForm() {
        step = 1;
        return new ForwardResolution("/META-INF/resources/m/wizard/select-schemas.jsp");
    }
    ...
    protected Resolution userManagementForm() {
        step = 2;
        return new ForwardResolution("/META-INF/resources/m/wizard/user-management.jsp");
    }
    ...
    protected Resolution selectTablesForm() {
        ...
        setupCalendarField();
        return new ForwardResolution("/META-INF/resources/m/wizard/select-tables.jsp");
    }
    ...
    protected Resolution buildAppForm() {
        ...
        return new ForwardResolution("/META-INF/resources/m/wizard/build-app.jsp");
    }
