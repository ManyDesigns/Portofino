        ...
        for (FieldSet fieldSet: from) {
            for (Field oldField: fieldSet) {
                ...
                if (propertyAccessor.type == String.class) {
                    ...
                    LinkedList<DiffMatchPatch.Diff> diffs = diffMatchPatch.diff_main(StringUtils.trimToEmpty(oldField.value==null?'':oldField.value), StringUtils.trimToEmpty(newField.value==null?'':oldField.value));
