...
public abstract class AbstractCrudAction<T> extends AbstractPageAction {
        ...
        if (form.validate()) {
            ...
            if(createValidate(object)) {
                ...
                if(isPopup()) {
                    ...
                    return new ForwardResolution("/m/portofino-database/pageactions/crud/popup/close.jsp");
                } else {
    ...
    protected Resolution getBulkEditView() {
        return new ForwardResolution("/m/portofino-database/pageactions/crud/bulk-edit.jsp");
    }
    ...
    protected Resolution getCreateView() { //TODO spezzare in popup/non-popup?
        if(isPopup()) {
            return new ForwardResolution("/m/portofino-database/pageactions/crud/popup/create.jsp");
        } else {
            return new ForwardResolution("/m/portofino-database/pageactions/crud/create.jsp");
        }
    }
    ...
    protected Resolution getEditView() {
        return new ForwardResolution("/m/portofino-database/pageactions/crud/edit.jsp");
    }
    ...
    protected Resolution getReadView() {
        return forwardTo("/m/portofino-database/pageactions/crud/read.jsp");
    }
    ...
    protected Resolution getEmbeddedReadView() {
        return new ForwardResolution("/m/portofino-database/pageactions/crud/read.jsp");
    }
    ...
    protected Resolution getSearchView() {
        return forwardTo("/m/portofino-database/pageactions/crud/search.jsp");
    }
    ...
    protected Resolution getEmbeddedSearchView() {
        return new ForwardResolution("/m/portofino-database/pageactions/crud/search.jsp");
    }
    ...
    protected Resolution getSearchResultsPageView() {
        return new ForwardResolution("/m/portofino-database/pageactions/crud/datatable.jsp");
    }
    ...
    protected Resolution notInUseCase(ActionBeanContext context, List<String> parameters) {
        ...
        return new ForwardResolution("/m/portofino-database/pageactions/redirect-to-last-working-page.jsp");
    }
