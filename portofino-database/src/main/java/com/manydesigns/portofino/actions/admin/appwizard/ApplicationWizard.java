...
public class ApplicationWizard extends AbstractWizardPageAction {
    ...
    protected Resolution createConnectionProviderForm() {
        step = 0;
        return new ForwardResolution("/m/portofino-database/actions/admin/appwizard/connection-provider.jsp");
    }
    ...
    protected Resolution selectSchemasForm() {
        step = 1;
        return new ForwardResolution("/m/portofino-database/actions/admin/appwizard/select-schemas.jsp");
    }
    ...
    protected Resolution userManagementForm() {
        step = 2;
        return new ForwardResolution("/m/portofino-database/actions/admin/appwizard/user-management.jsp");
    }
    ...
    protected Resolution selectUserFieldsForm() {
        step = 3;
        return new ForwardResolution("/m/portofino-database/actions/admin/appwizard/select-user-fields.jsp");
    }

    protected Resolution selectTablesForm() {
        step = (userTable == null) ? 3 : 4;
        setupCalendarField();
        return new ForwardResolution("/m/portofino-database/actions/admin/appwizard/select-tables.jsp");
    }
    ...
    protected Resolution buildAppForm() {
        ...
        return new ForwardResolution("/m/portofino-database/actions/admin/appwizard/build-app.jsp");
    }
