...
public class ConnectionProvidersAction extends AbstractActionBean {
    ...
    public Resolution search() {
        ...
        return new ForwardResolution("/m/database/actions/admin/connectionProviders/list.jsp");
    }
    ...
    public Resolution read() {
        ...
        return new ForwardResolution("/m/database/actions/admin/connectionProviders/read.jsp");
    }
    ...
    public Resolution edit() {
        ...
        return new ForwardResolution("/m/database/actions/admin/connectionProviders/edit.jsp");
    }
