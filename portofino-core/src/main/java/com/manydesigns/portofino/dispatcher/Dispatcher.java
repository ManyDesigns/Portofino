...
//            } catch (Exception e) {
//                logger.error("Cannot load rootFactory page", e);
//                return null;
//            }
//        } else {
...
//
//        public Root() {
//            Page rootPage = PageLogic.getPage(pagesDirectory);
...
//            PageAction subpage = PageLogic.getSubpage(configuration, pageInstance, pathFragment);
