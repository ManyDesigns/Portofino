...
/**
 * A <em>Dispatch</em> is an object representing a path of page instances from the rootFactory of the application,
...
public class Dispatch {
    ...
    /**
     * Returns the rootFactory page instance, the first in the path.
     */
