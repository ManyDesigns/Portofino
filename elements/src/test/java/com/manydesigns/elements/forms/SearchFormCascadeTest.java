...
public class SearchFormCascadeTest  extends AbstractElementsTest {
    ...
    public void testHtml() {
        ...
        assertEquals(
                "<div class=\"searchform\"><div class=\"form-group\"><label for=\"p1\" class=\"control-label\">P1</label><select id=\"p1\" name=\"p1\" class=\"form-control\"><option value=\"\" selected=\"selected\">-- Select p1 --</option><option value=\"1\">paperino</option><option value=\"2\">cip</option></select><script type=\"text/javascript\">$('#p1').change(function() {updateSelectOptions('selectionProvider', 1, 'jsonSelectFieldSearchOptions', '#p1', '#p2');});</script></div><div class=\"form-group\"><label for=\"p2\" class=\"control-label\">P2</label><select id=\"p2\" name=\"p2\" class=\"form-control\"></select></div></div>",
                text);
        ...
        assertEquals("<div class=\"searchform\"><div class=\"form-group\"><label for=\"p1\" class=\"control-label\">P1</label><select id=\"p1\" name=\"p1\" class=\"form-control\"><option value=\"\">-- Select p1 --</option><option value=\"1\" selected=\"selected\">paperino</option><option value=\"2\">cip</option></select><script type=\"text/javascript\">$('#p1').change(function() {updateSelectOptions('selectionProvider', 1, 'jsonSelectFieldSearchOptions', '#p1', '#p2');});</script></div><div class=\"form-group\"><label for=\"p2\" class=\"control-label\">P2</label><select id=\"p2\" name=\"p2\" class=\"form-control\"><option value=\"\" selected=\"selected\">-- Select p2 --</option><option value=\"1\">qui</option><option value=\"2\">quo</option><option value=\"3\">qua</option></select></div></div>", text);
    }
