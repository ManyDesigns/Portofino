 ...
 */
public class ElementsActionBeanContextFactory implements ActionBeanContextFactory {
    ...
    public ActionBeanContext getContextInstance(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        ElementsActionBeanContext elementsContext = ElementsThreadLocals.getElementsContext();
        //Set request, response to the ones wrapped by Stripes
        elementsContext.setRequest(request);
        elementsContext.setResponse(response);
